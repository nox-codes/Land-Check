...
export const AuthShell: React.FC<AuthShellProps> = ({ children, title, subtitle }) => (
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', minHeight: '100vh' }}>
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', maxWidth: 420, width: '100%', margin: '0 auto', paddingBlock: 48 }}>
        {title && (
          <div style={{ marginBottom: 32 }}>
            <h1 style={{ fontSize: 28, fontWeight: 700, color: 'var(--lc-text)', letterSpacing: '-0.02em', margin: 0 }}>{title}</h1>
